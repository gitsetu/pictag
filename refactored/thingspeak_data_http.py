...
def send_to_thingspeak(temperature,state,presence):
    payload = {
...
while True:
    ...
    presence=len(devices_found)

    print(f"Temperature: {temperature} C, Light: {led}")
    # print(f"Temperature: {temperature} C, Light: {led}, Presence: {presence} ")

    # print(led_status["ledcode"])

    # Send the data to ThingSpeak
    # send_to_thingspeak(temperature,ledcode)
    send_to_thingspeak(temperature,ledcode,presence)
